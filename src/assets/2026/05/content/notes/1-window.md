...
- Between two and five is an environment that you have control over...
...
The friction makes it harder for your focus to shift between contexts. You are making the tradeoff between split attention and multitasking for focus. It's risky to decide to focus on just one thing and cut yourself off from everything else, but there is a positive consequence of having a single application like [WriteRoom](https://www.hogbaysoftware.com/products/writeroom/) open: in that situation, all you have is the application and your focus.

When you make the trade-off to remove your attention from other applications, you gain more focus. Focus is more uncomfortable than attention, though; it's a trickier thing to work with. With different applications open and your attention split, your focus has room to move. Keeping a concentrated, still focus creates discomfort.
...
The *you* writing with instant messaging open and with the TV on, is not the same as the *you* who is focused.
