...
Switching to using the built in iOS apps gave me an opportunity to discover some of the powerful things they can do. For instance with Calendar and Reminders, by using iCal or iCloud.com you can share your iCloud calendar with others, and give them write access. This also works with Reminders. You can for example create a reminder list that you and your partner share, that you can both add reminders to. None of this is explained on iOS or is obvious the desktop, but it’s pretty cool.
...
Sparrow: [http://sparrowmailapp.com/](http://sparrowmailapp.com/)
