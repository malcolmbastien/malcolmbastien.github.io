...
> You can be the most brilliant leader in the history of humanity with the best ideas but if the context isn't right for a change it won't happen. If the conditions are right then the smallest push will set things moving.
>
> Dave Snowden, What is the locus of change?
...
> Nudges are small, contextual interventions that change the decision-making context (not incentives) in order to encourage behavioural change
>
> Linda Doyle, [Change & Complexity: Vector Theory of Change](https://cdn.cognitive-edge.com/wp-content/uploads/sites/12/2022/02/02160119/VTOC-paper-2022.pdf)
...
- **Don't rely on top-down directives to drive change:** Management-driven change can create resistance and weaken team decision-making. Instead, pull out the challenge to be solved and make that the focus. Invite people to address that challenge together.
