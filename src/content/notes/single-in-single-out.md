...
For these problems we can sometimes fix the problem by correctly linking our accounts together, or by taking advantage of tools that are out there. Other times we can only rely on services to adopt technologies like OpenID. None of the tools that can help us with these bad are perfect, but they're on their way.

## Pushing Content

Ping.fm is a great way to push out micro-blog updates, status updates, and social-bookmarks through one service. As of now, these are the services that I have integrated through Ping.fm:
...
- [Rejaw](http://rejaw.com/)
- [Delicious](http://delicious.com/)
- [Koornk](http://www.koornk.com/)
- [Flickr](http://flickr.com/)
- [Utterli](http://utterli.com/)

Ping.fm also has a ton of integration with different applications and tools at the Application Gallery http://ping.fm/apps/, which is great as it provide a lot of flexibility in publishing to different networks, and then flexibility in where you want to do your publishing. The great thing about Ping.fm is that if more social networks enter the scene, you can create and account, link it to Ping.fm once and be done with it. Suddenly more social networks does not add any more mental weight.

Another service that is similar to Ping.pm is Pixelpipe, though I haven't spent enough time with it yet to really figure it out.

## Consuming Content

For reading content? Friendfeed.

I still have problems sometimes when trying to use Friedfeed.com for an extended period of time, but more recently I've come to appreciate how much time it saves me. It's able to provide richer information than the Twitter stream, lets you participate by a sutble "Like" if you don't want to leave a full comment.
...
Can you be more efficient by using only Ping.fm for pushing content, and Friendfeed for consuming?
