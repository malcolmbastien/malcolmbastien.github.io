...
slug: starting-a-wardley-map-with-a-mental-model-diagram
tags:
...
- Which parts of our business we build in-house, using off-the-shelf goods, and which functions should be outsourced to partners.
