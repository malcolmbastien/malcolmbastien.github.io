...
slug: my-initial-experience-with-icloud
tags:
  - Day One
  - General
  - iA Writer
...
Compared to [Notational Velocity](http://notational.net/), another writing tool I use regularly, this process has been more trouble than its worth.

Just to illustrate how quick Notational Velocity’s workflow is: I type the title of the note I want to create and hit *“Enter”* once to create a new note, write, then hit *“Command + Delete”* to delete it. I have my data on NV synced using [Simplenote](http://simplenoteapp.com/) making the data accessible from multiple devices.

So I don’t think iCloud is great in iA Writer. That said, I do look forward to seeing more apps come out with iCloud support. The latest version of [Day One](http://dayoneapp.com/) will also include iCloud support and I can see its implementation of using iCloud as a no-hassle data backend as being more trouble free compared with using it as an additional file management outlet.
