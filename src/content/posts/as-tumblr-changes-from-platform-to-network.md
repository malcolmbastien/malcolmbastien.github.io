...
slug: as-tumblr-changes-from-platform-to-network
tags:
  - Blogging
  - General
  - Posterous
...
## Businesses Using Tumblr

Some of these problems also affect the business Tumble users.
...
One point from the SayYeah article is that they can’t follow users from the group blog. That may be a small problem, but it does demonstrate a limit in the ability of companies on Tumblr to connect with their audiences. They later bring up how being able to sort Tumblr users into groups would make it easier to follow tumblogs contextually (aka lists). This resembles the ways that companies can now filter and segment messages from users on Twitter.

So while Tumblr may be a great platform for businesses to use to do some social blogging, if they decide to have a group run blog, they can’t use the platform in the same way that individuals use it.

All the service outages we are seeing with Tumblr now are because of how many new people are joining the platform and starting multiple tumblogs. It’s a good platform with a high growth rate. So what I outlined here may still be what’s yet to come for them.

[You Say Yeah: The pros & cons of moving to Tumblr.](http://yousayyeah.com/post/932005114/the-pros-cons-of-moving-to-tumblr)
