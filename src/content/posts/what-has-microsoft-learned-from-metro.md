...
The two approaches are distinct. Even though Apple has had years to see millions of users use iOS on multiple generations of devices, they are gradually brining items from iOS to the Mac. Microsoft on the other hand will be changing the Windows desktop to the [Metro design language](http://en.wikipedia.org/wiki/Metro_(design_language)) overnight near the end of this year.
