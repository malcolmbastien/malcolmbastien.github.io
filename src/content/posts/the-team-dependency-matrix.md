...
Identify the teams in scope and create a table with the team names set as column and row headers.

Add the scope a team plans to deliver at each cell where the team intersects with itself.

For each row, capture what dependencies that team has on others in the different columns.
