...
If Apple didn't make their laptops, they [conceivably] wouldn't know that traits like instant on, and long battery life were desired by customers or in what amount.
...
Think about how hardware is the interface between software and the user. The ubiquity of a glass multitouch track pad across apple devices and the software support for gesture interactions, including kinetic scrolling, can only happen together when all the pieces of the puzzle are considered.

The learning only continues from there. Think about how hardware and the internals influenced future devices, like an operating system optimized for flash memory.

Google is the closest competitor who could possibly go down this path, if they release their own laptop running a Google operating system.
