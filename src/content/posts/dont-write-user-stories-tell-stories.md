...
Modelling systems and user flows using techniques like the [C4 Model](https://c4model.com/), [EventStorming](https://www.eventstorming.com/), or [Domain Storytelling](https://domainstorytelling.org/) can benefit teams by encouraging more collaborative discussions about software systems and use cases to create shared understanding. When it comes to the details of a story, [Example Mapping](https://cucumber.io/blog/bdd/example-mapping-introduction/) is a collaborative way for teams to discuss rules and system behaviours.
