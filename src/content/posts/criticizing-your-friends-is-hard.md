...
Feedback, continual improvement, and renewal (I'm tempted to use the term "refresh") are fundamental to positive growth. Hell, it's why [Rypple](http://rypple.com) exists (Though in my opinion Rypple is difficult to use in open feedback situations).
