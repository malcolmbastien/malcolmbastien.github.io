...
tags:
  - General
---
Ok, so we all have a pretty good understanding of what [augmented reality](http://en.wikipedia.org/wiki/Augmented_reality) systems look like. Give us a viewport into the world we see everyday, and overlay on top of that whether through a smartphone or through virtual glasses information that helps us.
...
While web apps for year already have been giving us the power to interact with content in different ways than ever before imagined, for along time they've only applied to one or two different types of media. [Flickr](http://www.flickr.com) took our photos and added a bunch of new stuff on top of the photo itself. [YouTube](http://www.youtube.com/) did this with our videos. Where we used to have static media objects, we then got these great social objects that we could comment on, share, send around and post in all these different places online.
...
Now we have two services which don't seem very close, but that I think share some thing very interesting in common. [Evernote](http://www.evernote.com/) and [Posterous](http://posterous.com/). One handles notes and capturing personal information, the other handles sharing content and media files with others on a blog. The one thing I think they have in common is the fact that they are both marketed somewhat in being able to used to either capture or share many different types of media.
