...
- [FriendFeed Beta](http://beta.friendfeed.com)
- [Facebook](http://facebook.com)
- [PostRank](http://postrank.com)
- [Blellow](http://blellow.com)

What's interesting about this is that sites that do more than just micro blogging are deciding to change the design and flow of their sites to mimic the microblogging design started by Twitter.  Do existing web properties see something in the way Twitter brings people together, that they want a piece of that action for their own communities and the way people use their sites? It looks like it.

It also looks like people are seeing creative ways in which communities and people, organized how they are on Twitter, but given a more complex set of tools and systems, can accomplish a higher level of work together.
