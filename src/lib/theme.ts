...
export const theme = {
  ...
  status: {
    ...
    sprout: {
      ...
      glow: "hover:shadow-emerald-200/50 dark:hover:shadow-emerald-800/50",
    ...
    tree: {
      ...
      glow: "hover:shadow-emerald-200/75 dark:hover:shadow-emerald-700/50",
